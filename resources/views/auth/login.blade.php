                ...
                <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-4 control-label disabled color-palette custom-label">Username</label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label disabled color-palette custom-label">Password</label>
                    ...
                    <div class="box-footer custom-footer">
                        <button style="font-weight: bold;" type="submit" class="btn btn-default pull-left">Login</button>
                    </div>
                </form>
            </div>
        </div>
