<nav aria-label="Page navigation" style="float: right; width: auto;">
    <label class="custom-label-pagination">
        Total <span style="color: #dd4b39;">{{ $page['total'] }}</span>
    </label>
    <label class="custom-label-pagination">
        {{ $page['currentPage'] ? $page['currentPage'] : 1 }}/{{ $page['totalPage'] ? $page['totalPage'] : 1}} Page
    </label>
    <ul class="justify-content-end custom-pagination">
        <li class="page-item @if($page['currentPage'] == 1 || $page['currentPage'] == 0) disabled @endif">
            <span class="page-link" onclick="pageing( 1 )">First</span>
        </li>
        <li class="page-item @if($page['currentPage'] == 1 || $page['currentPage'] == 0) disabled @endif">
            <span class="page-link" onclick="pageing( {{ $page['currentPage'] - 1 }} )" tabindex="-1">Previous</span>
        </li>
        ...
        <li class="page-item @if($page['totalPage'] == $page['currentPage']) disabled @endif">
            <span class="page-link" href="#" onclick="pageing( {{ $page['currentPage'] + 1 }} )">Next</span>
        </li>
        <li class="page-item @if($page['totalPage'] == $page['currentPage']) disabled @endif">
            <span class="page-link" onclick="pageing( {{ $page['totalPage'] }} )">Last</span>
        </li>
    </ul>
</nav>