...
class LoginAdminController extends AdminBaseController
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        $messages = [
            'name.required' => __('Username or password was incorrect.'),
            'password.required' => __('Username or password was incorrect.')
        ];
        ...
        if (!$user || ($user->name != $name) || !Hash::check($password, $user->password)) {
            $errors = new MessageBag(['error_login' => 'Username or password was incorrect.']);
        ...
        return redirect(URL::route('employee.index'));
    }
